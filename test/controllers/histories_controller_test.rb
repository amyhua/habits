...
class HistoriesControllerTest < ActionController::TestCase
  ...
  test "should create history" do
    assert_difference('History.count') do
      post :create, history: { body: @history.body, opt_timestamp: @history.opt_timestamp, tagline: @history.tagline }
    end
  ...
  test "should update history" do
    patch :update, id: @history, history: { body: @history.body, opt_timestamp: @history.opt_timestamp, tagline: @history.tagline }
    assert_redirected_to history_path(assigns(:history))
  end
